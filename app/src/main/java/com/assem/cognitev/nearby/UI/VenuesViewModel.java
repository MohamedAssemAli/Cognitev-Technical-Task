    ...
    public Observable<Response<JsonObject>> getVenues(Location location) {
        ...
        observable.subscribe(jsonObject -> {
                    try {
                        ...
                        items = new Gson().fromJson(jsonArray.toString(), new TypeToken<ArrayList<Item>>() {
                        }.getType());
    ...
    public Observable<Response<JsonObject>> getVenuePhotos(String venueId) {
        ...
        observable.subscribe(jsonObject -> {
                    try {
                        ...
                        venuePhoto = new Gson().fromJson(responseObject.toString(), new TypeToken<VenuePhoto>() {
                        }.getType());

                        Log.d(TAG, "getVenuePhotos: " + venuePhoto.getSuffix());
                    } catch (Exception e) {
                        Log.d(TAG, "onResponse: exception =>" + e.getMessage());
//                        onErrorMutableLiveData.setValue(true);
                    }
