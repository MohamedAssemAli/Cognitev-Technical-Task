...
public class AutoFitTextView extends AppCompatTextView {
    ...
    public AutoFitTextView(final Context context, final AttributeSet attrs, final int defStyle) {
        super(context, attrs, defStyle);
        // using the minimal recommended font size
        _minTextSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 1, getResources().getDisplayMetrics());
        ...
        _sizeTester = new SizeTester() {
            ...
            public int onTestSize(final int suggestedSize, final RectF availableSpace) {
                ...
                if (transformationMethod != null)
                    text = transformationMethod.getTransformation(getText(), AutoFitTextView.this).toString();
                else
