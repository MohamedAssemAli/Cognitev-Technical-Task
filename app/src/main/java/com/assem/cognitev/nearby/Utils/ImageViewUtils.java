...
//                .apply(new RequestOptions().placeholder(R.drawable.img_placeholder))
    ...
    public static void circularImage(Context context, ImageView imageView, Uri imgPath) {
        Glide.with(context)
                .load(imgPath)
                .transition(new DrawableTransitionOptions().crossFade())
                .apply(new RequestOptions().circleCrop())
//                .apply(new RequestOptions().placeholder(R.drawable.img_placeholder))
    ...
    public static void circularImage(Context context, ImageView imageView, String imgPath) {
        Glide.with(context)
                .load(imgPath)
                .transition(new DrawableTransitionOptions().crossFade())
                .apply(new RequestOptions().circleCrop())
    ...
    public static void circularImage(Context context, ImageView imageView, int imgPath) {
        Glide.with(context)
                .load(imgPath)
                .transition(new DrawableTransitionOptions().crossFade())
                .apply(new RequestOptions().circleCrop())
...
//                .apply(new RequestOptions().placeholder(R.drawable.img_placeholder))
    ...
    public static void fitImage(Context context, ImageView imageView, String imgPath) {
        Glide.with(context)
                .load(imgPath)
                .transition(new DrawableTransitionOptions().crossFade())
                .apply(new RequestOptions().fitCenter())
...
//                .apply(new RequestOptions().placeholder(R.drawable.img_placeholder))
    ...
    public static void fitImage(Context context, ImageView imageView, Uri imgPath) {
        Glide.with(context)
                .load(imgPath)
                .transition(new DrawableTransitionOptions().crossFade())
                .apply(new RequestOptions().fitCenter())
